...
```text		
>git clone https://github.com/ongj/candidateUpdates
```
<br>
...
12. Go back to the `Dashboard`, click the widget of your application, then click `Add a Service or API` again. <br>
